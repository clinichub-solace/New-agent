...
Date: 2025-08-19
Environment: Preview (https://medoffice-suite.preview.emergentagent.com)
...
- Frontend runtime env (console):
  - REACT_APP_BACKEND_URL = https://medoffice-suite.preview.emergentagent.com
  - API = https://medoffice-suite.preview.emergentagent.com/api
  - FORCED_URL = http://192.168.0.243:8001 (debug-only; not used for requests)
- Requests observed:
  - POST https://medoffice-suite.preview.emergentagent.com/api/auth/login → 200 OK
...
- URL: https://medoffice-suite.preview.emergentagent.com
