...
Date: 2025-08-19
Environment: Preview (https://health-platform-3.preview.emergentagent.com)
...
- Frontend runtime env (console):
  - REACT_APP_BACKEND_URL = https://health-platform-3.preview.emergentagent.com
  - API = https://health-platform-3.preview.emergentagent.com/api
  - FORCED_URL = http://192.168.0.243:8001 (debug-only; not used for requests)
- Requests observed:
  - POST https://health-platform-3.preview.emergentagent.com/api/auth/login → 200 OK
...
- URL: https://health-platform-3.preview.emergentagent.com
