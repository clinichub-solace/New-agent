...
# FORCE ATLAS CONNECTION - Use new environment variable to bypass preserved secrets
...
print("🚨 CRITICAL: Forcing Atlas connection with new variable bypass")
print(f"🌐 Atlas connection configured with optimized timeouts")
