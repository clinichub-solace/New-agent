...
def main():
    ...
    print("\nSummary:")
    print("1. ICD-10 Database Endpoints:")
    print("   - POST /api/icd10/init - Successfully initializes ICD-10 codes")
    print("   - GET /api/icd10/search?query=diabetes - Successfully searches for diabetes-related codes")
    print("   - GET /api/icd10/search?query=hypertension - Successfully searches for hypertension-related codes")
    print("   - GET /api/icd10/comprehensive - Successfully retrieves all ICD-10 codes")
    print("   - GET /api/icd10/comprehensive?category=Cardiovascular - Successfully filters by category")
    print("\n2. Comprehensive Medication Database Endpoints:")
    print("   - POST /api/medications/init-comprehensive - Successfully initializes the medication database")
    print("   - GET /api/medications/search?query=blood pressure - FAILED with 500 error")
    print("   - GET /api/medications/search?query=diabetes - FAILED with 500 error")
    print("   - GET /api/medications/search?query=lisinopril - FAILED with 500 error")
    print("   - GET /api/medications/comprehensive - FAILED with 500 error")
    print("   - GET /api/medications/comprehensive?drug_class=NSAID - FAILED with 500 error")
    print("\nDiagnosis:")
