...
def test_appointment_scheduling(patient_id, provider_id, admin_token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            patient_name = f"{patient_data['name'][0]['given'][0]} {patient_data['name'][0]['family']}"
    except:
        pass
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            provider_name = f"{provider_data['title']} {provider_data['first_name']} {provider_data['last_name']}"
    except:
        pass
